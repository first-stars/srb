...
import com.w.srb.core.mapper.LendItemMapper;
import com.w.srb.core.mapper.LendMapper;
import com.w.srb.core.mapper.LendReturnMapper;
...
import com.w.srb.core.mapper.LendItemReturnMapper;
...
public class LendItemReturnServiceImpl extends ServiceImpl<LendItemReturnMapper, LendItemReturn> implements LendItemReturnService {
    ...
    public List<LendItemReturn> selectByLendId(Long lendId, Long userId) {
        ...
        lendItemReturnQueryWrapper.eq("lend_id",lendId).eq("invest_user_id", userId).orderByAsc("current_period");
